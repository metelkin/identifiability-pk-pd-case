...
pool_2 = read_scenarios("models/01-multicompartment-pkpd/scenarios/pool-2.csv")
add_scenarios!(p, pool_2)
...
CSV.write("data/01-multicompartment-pkpd/profile-1/vp-validation-personal-1.csv", mc_df)

fig = plot(mc_res)
savefig(fig, "data/01-multicompartment-pkpd/profile-1/vp-validation-personal-1.png")
...
CSV.write("data/01-multicompartment-pkpd/profile-1/vp-validation-mean_sd-1.csv", df)
...
savefig(final_plot, "data/01-multicompartment-pkpd/profile-1/vp-validation-mean_sd-1.png")
...
CSV.write("data/01-multicompartment-pkpd/profile-1/vp-validation-quartile-1.csv", df)
...
savefig(final_plot, "data/01-multicompartment-pkpd/profile-1/vp-validation-quartile-1.png")
...
CSV.write("data/01-multicompartment-pkpd/profile-1/vp-validation-quantile-1.csv", df)
...
final_plot = plot(plots..., layout = (length(plots), 1), size = (800, 300 * length(plots)))
savefig(final_plot, "data/01-multicompartment-pkpd/profile-1/vp-validation-quantile-1.png")